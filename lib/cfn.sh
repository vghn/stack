...
cfn_process_stacks(){
  ...
  case "$stack" in
    vgh)
      ...
      P="${P} ParameterKey=RheaAMIId,ParameterValue=$(vgs_aws_ec2_get_trusty_base_image_id)"
      ...
      P="${P} ParameterKey=VolumeName,ParameterValue=${AWS_EFS_VOLUME}"
      ...
      P="${P} ParameterKey=EFSTemplateURL,ParameterValue=${AWS_CFN_STACKS_URL}/efs.json"
